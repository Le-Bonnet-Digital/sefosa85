...
import { Routes, Route } from "react-router-dom"; // 👈 pas BrowserRouter
      ...
      <div className="min-h-screen bg-white">
        ...
        <main>
          <Routes>
            ...
            <Route
              path="/formations/secourisme"
              element={<FormationsSecourismePage />}
            />
            <Route path="/formations/secourisme/sst" element={<SSTPage />} />
            <Route
              path="/formations/secourisme/mac-sst"
              element={<MacSSTPage />}
            />
            <Route path="/formations/secourisme/psc1" element={<PSC1Page />} />
            <Route
              path="/formations/secourisme/gestes-qui-sauvent"
              element={<GQSPage />}
            />
            <Route path="/formations/secourisme/pse1" element={<PSE1Page />} />
            <Route path="/formations/secourisme/pse2" element={<PSE2Page />} />
            <Route
              path="/formations/incendie"
              element={<FormationsIncendiePage />}
            />
            <Route path="/formations/incendie/epi" element={<EPIPage />} />
            <Route
              path="/formations/incendie/extincteur"
              element={<ExtincteurPage />}
            />
            <Route
              path="/formations/incendie/evacuation"
              element={<EvacuationPage />}
            />
            <Route
              path="/devis-et-calendrier"
              element={<DevisCalendrierPage />}
            />
            <Route path="/avis" element={<AvisPage />} />
            <Route path="/a-propos" element={<AProposPage />} />
            <Route path="/vendee" element={<VendeePage />} />
            <Route
              path="/vendee/la-roche-sur-yon"
              element={<LaRocheSurYonPage />}
            />
            <Route
              path="/vendee/les-sables-d-olonne"
              element={<LesSablesDOlonnePage />}
            />
